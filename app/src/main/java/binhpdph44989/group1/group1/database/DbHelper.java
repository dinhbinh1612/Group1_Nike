...
public class DbHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String dbGiay = "CREATE TABLE GIAY(magiay integer PRIMARY KEY AUTOINCREMENT,tengiay text,hinhanh text,size integer,giaban integer,soluongkho INTEGER,soluong integer,maloai integer references LOAIGIAY(maloai))";
        db.execSQL(dbGiay);
        String dbCTDonHang = "CREATE TABLE CTDONHANG(madh integer PRIMARY KEY AUTOINCREMENT,makh integer references KHACHHANG(makh),magiay integer references GIAY(magiay),ngaydat text,trangthaidonhang integer,tongtien integer,soluong integer references GIAY(soluong))";
        ...
        db.execSQL("INSERT INTO GIAY VALUES (1,'AF1','avatar1',42,200,10,4,1),(2,'AIRMAX','avatar2',37,100,11,5,2),(3,'JORDAN1','avatar3',40,250,12,7,1),(4,'JORDAN','avatar4',40,300,15,1,1),(5,'AF2','avatar5',39,200,19,1,2),(6,'AF1','avatar6',44,200,21,1,1),(7,'AF12','avatar7',43,200,9,1,1),(8,'NIKE1','avatar8',42,200,7,1,2),(9,'AIRMIN','avatar9',38,900,17,1,2),(10,'AF123','avatar10',41,200,6,1,1),(11,'TRUNK','avatar11',40,400,23,1,1),(12,'JORDAN!','avatar12',39,200,13,1,2)");
        db.execSQL("INSERT INTO CTDONHANG VALUES (1,1,1,'11/03/2024',0,2000000,4),(2,2,2,'14/03/2024',0,3000000,5),(3,3,3,'11/03/2024',0,2000000,7),(4,2,2,'17/03/2024',0,2000000,1),(5,1,1,'19/03/2024',0,2000000,1)");
